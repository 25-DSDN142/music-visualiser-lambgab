...
//Randomise Ripples Position / Leave alone for now until Animation is sorted.
   //let vocal_pos_x;
   //let vocal_pos_y;
...
// CHANGES 
 //RIPPLES
   ...
   // vocal bar is deep orange 
     ...
     if (ellipse_height > 30){

     noFill();
     stroke(20, 93, 34);
     strokeWeight(5);
     circle(ellipse_pos_x, height / 2 + 1 * ellipse_spacing, 4 * vocal, ellipse_height + 1
     );
     fill(0);
